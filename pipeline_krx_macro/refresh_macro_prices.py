...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Refresh KRX macro market/FRED data into data/macro_prices.sqlite.")
    ...
    try:
        result = refresh_macro_prices(db_path=args.db_path or None, years=args.years, require_fred=bool(args.require_fred))
    except Exception as exc:
