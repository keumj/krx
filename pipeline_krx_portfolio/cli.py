...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Independent portfolio lab over the shared KRX DB.")
    ...
    parser.add_argument("--port", type=int, default=8525, help="Port for --web-gui")
...
def main() -> None:
    ...
    try:
        ...
        _print_frame("KRX Replication", optimization.replication)
