...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Independent KRX stock news analysis tool over the shared SQLite DB.")
    ...
    parser.add_argument("--port", type=int, default=8524, help="Port for --web-gui")
