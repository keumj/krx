...
_DASHBOARD_FRAME_FIELDS = [
    ...
    "relative_risk_decomposition",
    "stock_selection_risk",
    "var_summary",
    "incremental_var",
    "risk_contribution",
...
def load_dashboard_snapshot(user_id: str) -> SnapshotEnvelope | None:
    ...
    dashboard = PortfolioDashboard(
        ...
        relative_decomposition=_deserialize_frame(frames.get("relative_decomposition")),
        ...
        relative_risk_decomposition=_deserialize_frame(frames.get("relative_risk_decomposition")),
        stock_selection_risk=_deserialize_frame(frames.get("stock_selection_risk")),
        var_summary=_deserialize_frame(frames.get("var_summary")),
        incremental_var=_deserialize_frame(frames.get("incremental_var")),
